...
class ReactToTouch(ALModule):
    ...
    def onTouched(self, subscriber, value):
        ...
        """
        #memory.unsubscribeToEvent("LeftBumperPressed","ReactToTouch")
        global counter
        global checkIntro
        global checkSayName
        global checkSaludar
        ...
        #memory.subscribeToEvent("LeftBumperPressed","ReactToTouch", "onTouched")
    ...
    def Intro(self):
        ...
        if checkIntro == True:
            ...
            for x in range(0,2):
                ...
                self.move(names, anglesd, fractionMaxSpeed) #Centro: llama a funcion "move" con angulos declarados previamente
                time.sleep(4.0)
    ...
    def AnticipacionSocial(self):
        ...
        self.postureProxy.goToPosture("Sit", 0.6)
        self.intermediate() #esta posicion asegura que el robot no choque sus brazos con las rodillas al realizar la accion
        self.coverEyes()
    ...
    def hiHand(self):
        ...
        pitch = 15.0
        yaw = 20.0
        shortInterval = 0.1 #Ajustar el tiempo que pasa entre accion en el saludo para lograr mas fluidez
        longInterval = 0.3
        neutralInterval = 0.2 
        #1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="10.100.144.70",
